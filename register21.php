                                                    ...
                                                    <div class="col-xl-6">
                                                        <div class="request-a-pickup__tab-content-input-box">
                                                            <input id="noofHouse_appartment1" type="text" maxlength="3"
                                                                placeholder="No of houses (Wet)*" name="number1" oninput="printvalue()" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6">
                                                        <div class="request-a-pickup__tab-content-size-box">
                                                    ...
                                                    <div class="col-xl-6">
                                                        <div class="request-a-pickup__tab-content-input-box">
                                                            ...
                                                            <input id="noofHouse_appartment2" type="text" maxlength="3"
                                                                placeholder="No of houses (Dry)*" name="number2" required>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6">
                                                        <div class="request-a-pickup__tab-content-size-box">
                                                        ...
                                                        <div class="request-a-pickup__tab-content-size-box">
                                                            ...
                                                            <ul
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <div class="request-a-pickup__tab-content-input-box">
                                                                        <input id=" " type="text" maxlength="3" placeholder="No of Green Bins*" name="number" required>
                                                                    </div>
                                                                ...
                                                                <li>
                                                                    ...
                                                                    <div class="request-a-pickup__tab-content-input-box">
                                                                        <input id=" " type="text" maxlength="3" placeholder="No of White/Blue Bags*" name="number" required>
                                                                    </div>
...
<script>
    function printvalue(){
        var noofHouse = document.getElementById("noofHouse_appartment1");
        var hgfhg = noofHouse.value;
        console.log("test" + hgfhg);
    }
...
<script>
    ...
    // var noofHouse_appartment1 = document.getElementById("noofHouse_appartment1").value;
    // const noofHouse_appartment2 = document.getElementById("noofHouse_appartment2");
    // console.log(noofHouse_appartment1);
    // console.log(noofHouse_appartment2);
